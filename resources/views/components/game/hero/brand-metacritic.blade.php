<span {{ $attributes->class(['inline-flex shrink-0 items-center justify-center rounded-full bg-[#1d1d1d] p-1']) }}>
    <svg viewBox="0 0 24 24" fill="#ffcc33" class="h-full w-full" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
