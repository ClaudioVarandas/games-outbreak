            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
                ...
                <div class="lg:col-span-1">
                    <div class="bg-white dark:bg-gray-800 rounded-lg shadow-lg p-6">
                        <h2 class="text-xl font-bold mb-4 text-gray-900 dark:text-white">List Settings</h2>

                        <form action="{{ route('user.lists.lists.update', [$user->username, $list->slug]) }}" method="POST">
                            @csrf
                            @method('PATCH')
                            ...
                            <div class="mb-4">
                                ...
                                <p class="mt-1 text-xs text-gray-500 ml-6">When unchecked, only you can see this list.</p>
                            </div>
                            ...
                            <div class="mb-6">
                                ...
                                <p class="mt-1 text-xs text-gray-500 ml-6">Inactive lists are hidden from everyone except you.</p>
                            </div>
                ...
                <div class="lg:col-span-2">
                    ...
                    <div class="mt-6">
                        ...
                        @if($list->games->count() > 0)
                            <x-user-lists.game-grid :games="$list->games" :user="$user" :type="$list->slug" :viewMode="$viewMode" />
                        @else
