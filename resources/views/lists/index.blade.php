...
@section('content')
    <div class="container mx-auto px-4 py-8">
        <div class="flex justify-between items-center mb-10">
            ...
            <a href="{{ route('lists.create') }}" class="bg-teal-600 hover:bg-teal-700 text-white px-6 py-2 rounded-lg transition">
                Create New List
            </a>
        </div>
        ...
        <div class="mb-12">
            ...
            @else
                <div class="text-center py-12 bg-white dark:bg-gray-800 rounded-lg">
                    ...
                    <a href="{{ route('lists.create') }}" class="text-teal-600 hover:text-teal-700">
            ...
            @if(auth()->user()->isAdmin())
                <div>
                    ...
                    @else
                        <div class="text-center py-12 bg-white dark:bg-gray-800 rounded-lg">
                            <p class="text-xl text-gray-600 dark:text-gray-400">
                                No other users' lists available.
                            </p>
                        </div>
                    @endif
                </div>
