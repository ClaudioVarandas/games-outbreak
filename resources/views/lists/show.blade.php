                ...
                <div class="flex flex-col lg:flex-row gap-6">
                    ...
                    <main class="flex-1">
                        @if($gameList->isEvents() && !empty($gamesByMonth))
                            {{-- Events List: Month-grouped layout with game-card component --}}
                            @foreach($gamesByMonth as $monthKey => $monthData)
                                <div class="pt-10 first:pt-0">
                                    ...
                                    {{-- Games Grid --}}
                                    <div x-show="viewMode === 'grid'" class="grid grid-cols-1 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 xl:grid-cols-6 gap-8">
                            ...
                            {{-- Empty State for Events (no games) --}}
                            @if(count($gamesByMonth) === 0)
                                <div class="text-center py-16 bg-gray-800 rounded-xl">
                                    ...
                                    <p class="text-gray-400 text-lg">No games in this event yet.</p>
                                </div>
                            @endif

                            {{-- Empty State when filtered (all games hidden) --}}
