{{-- Status buttons --}}
<button @click="status = status === 'playing' ? null : 'playing'"
...
<button @click="status = status === 'played' ? null : 'played'"
        class="flex items-center gap-1.5 px-3 py-1.5 rounded-lg text-sm font-medium transition"
        :class="status === 'played' ? 'bg-purple-600 text-white ring-2 ring-purple-400' : 'bg-gray-700 text-gray-300 hover:bg-gray-600'">
    <svg class="w-3.5 h-3.5" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
...
<button @click="status = status === 'backlog' ? null : 'backlog'"
        class="flex items-center gap-1.5 px-3 py-1.5 rounded-lg text-sm font-medium transition"
        :class="status === 'backlog' ? 'bg-orange-600 text-white ring-2 ring-orange-400' : 'bg-gray-700 text-gray-300 hover:bg-gray-600'">
    <svg class="w-3.5 h-3.5" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
...
<button @click="isWishlisted = !isWishlisted"
        ...
        :class="isWishlisted ? 'text-red-400 bg-red-500/20' : 'text-gray-400 hover:text-red-400 hover:bg-gray-700'"
