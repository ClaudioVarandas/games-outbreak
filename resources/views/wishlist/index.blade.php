        ...
        @if($totalResults > 0)
            ...
            <div class="flex items-center justify-between mb-6">
                <div class="flex items-center gap-2">
                    <button
                        onclick="window.location.href='{{ route('wishlist', ['view' => 'grid', 'page' => $currentPage]) }}'"
                    ...
                    <button
                        onclick="window.location.href='{{ route('wishlist', ['view' => 'list', 'page' => $currentPage]) }}'"
            ...
            @if($viewMode === 'grid')
                <x-featured-games-glassmorphism 
                    ...
                    :initialLimit="999"
                    emptyMessage="No games in your wishlist."
                />
            @else
                <!-- List View -->
            ...
            @if($totalPages > 1)
                <div class="mt-8 flex items-center justify-center gap-2">
                    @if($currentPage > 1)
                        <a href="{{ route('wishlist', ['view' => $viewMode, 'page' => $currentPage - 1]) }}" 
        ...
        @else
            <div class="text-center py-12 bg-white dark:bg-gray-800 rounded-lg">
                ...
                <p class="text-sm text-gray-500 dark:text-gray-500">
                    Start adding games to your wishlist from game cards or game detail pages.
                </p>
            </div>
        @endif
    </div>
