    ...
    <div class="container mx-auto px-4 py-8">
        ...
        <section class="mb-12">
            <div class="flex items-center justify-between mb-6">
                ...
                @if($activeList)
                    <a href="{{ route('monthly-releases') }}" class="text-orange-600 dark:text-orange-400 hover:text-orange-700 dark:hover:text-orange-300 font-medium transition">
                        See all ->
                    </a>
                @endif
            </div>
            ...
            @elseif($activeList && $featuredGames->count() === 0)
                <div class="text-center py-12 bg-white dark:bg-gray-800 rounded-lg">
                    ...
                    <a href="{{ route('monthly-releases') }}" class="inline-block text-orange-600 dark:text-orange-400 hover:text-orange-700 dark:hover:text-orange-300 font-medium transition">
                        See all ->
                    </a>
                </div>
            @else
        ...
        <section class="mb-12">
            <div class="flex items-center justify-between mb-6">
                ...
                <a href="{{ route('upcoming') }}" class="text-orange-600 dark:text-orange-400 hover:text-orange-700 dark:hover:text-orange-300 font-medium transition">
                    See all ->
                </a>
            </div>
