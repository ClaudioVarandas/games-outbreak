  ...
  <div class="relative w-full" ref="searchContainer">
    <form @submit.prevent="submitSearch" class="relative">
      <input
        ...
        type="text"
        class="w-full px-6 py-3 text-base rounded-lg text-white focus:outline-none transition"
        :placeholder="placeholder"
        autocomplete="off"
        ref="input"
      >
      <button type="submit" class="absolute right-3 top-1/2 -translate-y-1/2 transition">
